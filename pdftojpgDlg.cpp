...
void pdftojpgDlg::CreateGUIControls()
{
	...
	WxStaticText3 = new wxStaticText(this, ID_WXSTATICTEXT3, wxT("Copyright (c) Code Industry Ltd"), wxPoint(22, 395), wxDefaultSize, 0, wxT("WxStaticText3"));
	...
	WxHyperLinkCtrl1 = new wxHyperlinkCtrl(this, ID_WXHYPERLINKCTRL1, wxT("http://code-industry.net"), wxT("http://code-industry.net"), wxPoint(21, 419), wxSize(171, 28), wxNO_BORDER | wxHL_CONTEXTMENU, wxT("WxHyperLinkCtrl1"));
